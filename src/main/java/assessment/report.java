...
public class report {
    ...
    public void testAddMultipleUsers() {
        ...
        Assert.assertTrue(userListTable.isDisplayed(), "User List Table is not displayed.");
        ...
        // Ensure that 2 users are added to the list
        for (String[] userDetail : userDetails) {
            ...
            Assert.assertTrue(addedUser.isDisplayed(), "Failed to add user " + username + ".");
        }
    }
